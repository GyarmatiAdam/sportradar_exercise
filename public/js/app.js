...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    post: function post() {
      ...
      this.author.name = "", this.author.date_of_birth = "", this.author.address = "", this.book.name = "", this.book.release_date = ""["catch"](function (error) {
        return _this.errors.record(error.response.data);
      });
    },
    validateInputs: function validateInputs(e) {//     if (this.aut_name && this.aut_birth && 
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchAuthorsWithBooks: function fetchAuthorsWithBooks() {
      var _this = this;

      fetch('api/authors-books').then(function (res) {
        return res.json();
      }).then(function (res) {
        _this.authors = res;
      });
    },
    addAuthorWithBook: function addAuthorWithBook() {
      var _this2 = this;
      ...
      fetch('api/author-book', {
        ...
        _this2.author.book.name = '';
        _this2.author.book.release_date = '';
        alert('Author with book added');

        _this2.fetchAuthorsWithBooks();
      })["catch"](function (err) {
  ...
  methods: {
    ...
    addBook: function addBook() {
      ...
      fetch('api/book', {
        ...
        _this4.book.name = '';
        _this4.book.release_date = '';
        _this4.book.authors_id = '';
        alert('Book added');
...
var render = function() {
  ...
  return _c("div", [
      ...
      "form",
      {
        ...
        on: {
          submit: function($event) {
            ...
            return _vm.validateInputs($event)
          }
        }
      },
      [
    ...
    _vm._v(" "),
    _c("h1", [_vm._v(_vm._s(_vm.author.name))]),
    _vm._v(" "),
    _c("h1", [_vm._v(_vm._s(_vm.author.date_of_birth))]),
    _vm._v(" "),
    _c("h1", [_vm._v(_vm._s(_vm.author.address))]),
    _vm._v(" "),
    _c("h1", [_vm._v(_vm._s(_vm.book.name))]),
    _vm._v(" "),
    _c("h1", [_vm._v(_vm._s(_vm.book.release_date))])
  ])
}
var staticRenderFns = []
render._withStripped = true
    ...
    _c(
      "form",
      {
        on: {
          submit: function($event) {
            $event.preventDefault()
            return _vm.addAuthorWithBook($event)
          }
        }
      },
      [
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.author.book.name,
                expression: "author.book.name"
              }
            ],
            staticClass: "form-control",
            attrs: { type: "text", placeholder: "Enter book's name" },
            domProps: { value: _vm.author.book.name },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.author.book, "name", $event.target.value)
              }
            }
          })
        ]),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.author.book.release_date,
                expression: "author.book.release_date"
              }
            ],
            staticClass: "form-control",
            attrs: { type: "date" },
            domProps: { value: _vm.author.book.release_date },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.author.book, "release_date", $event.target.value)
              }
            }
          })
        ]),
              ...
              return _c("div", { key: author.id, staticClass: "card" }, [
                _c("div", { staticClass: "card-body" }, [
                  ...
                  _c("h6", { staticClass: "card-subtitle mb-2 text-muted" }, [
                    _vm._v(_vm._s(author.date_of_birth))
                  ]),
                  _vm._v(" "),
...
/* harmony import */ var _views_Create__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/Create */ "./resources/js/views/Create.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/create',
    name: 'create',
    component: _views_Create__WEBPACK_IMPORTED_MODULE_6__["default"]
  }]
});
...
__webpack_require__(/*! C:\xampp\htdocs\sportradar\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\sportradar\resources\sass\app.scss */"./resources/sass/app.scss");
